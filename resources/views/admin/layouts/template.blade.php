...
<head>
  ...
  <title>JK:ADMIN | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">JomKahwin (Admin)</span>
    </a>
         ...
         <!--Management-->
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('adminmanageuser.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('adminmanagevendor.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Vendor</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('sserviceadmin.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Service</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route ('quotescrap.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quote</p>
                </a>
              </li>
...
<!-- daterangepicker -->
<script src="{{ asset('ad/plugins/moment/moment.min.js')}}"></script>
